...
class PortfolioWatchdog:
    ...
    def recommend_action(
        ...
        return self.evaluate_position(position, trend_proxy=trend_proxy, confidence_decay=confidence_decay)
    ...
    def evaluate_portfolio(
        ...
        for position in snapshot.positions.values():
            ...
            decisions.append(
                self.evaluate_position(position, trend_proxy=proxy, confidence_decay=confidence_decay)
            )
