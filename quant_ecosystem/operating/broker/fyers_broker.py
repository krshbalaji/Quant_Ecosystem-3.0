...
class FyersBroker:
    ...
    def connect(self):
        ...
        try:
            from quant_ecosystem.operating.broker.adapters.fyers_adapter import FyersAdapter
    ...
    def is_connected(self):
        mode = str(getattr(self._config, "mode", "PAPER") or "PAPER").upper()
        if mode == "PAPER" or self.account_source == "SIMULATED":
            return True
        return bool(self.connected and self.live_client is not None)
