...
from quant_ecosystem.operating.broker.adapters.coinswitch_adapter import CoinSwitchAdapter
...
class CoinSwitchBroker:
    ...
    def is_connected(self):
        ...
        if mode == "PAPER" or self.account_source == "SIMULATED":
            return True
        return bool(self.connected and self.account_source == "COINSWITCH_LIVE")
