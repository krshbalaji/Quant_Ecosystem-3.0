...
from quant_ecosystem.research.meta_strategy.strategy_diversification_engine import (
    StrategyDiversificationEngine,
)
from quant_ecosystem.research.meta_strategy.strategy_lifecycle_manager import (
    StrategyLifecycleManager,
)
from quant_ecosystem.research.meta_strategy.strategy_retirement_engine import (
    StrategyRetirementEngine,
)
from quant_ecosystem.research.meta_strategy.strategy_scoring_engine import StrategyScoringEngine
...
class MetaStrategyBrain:
    ...
    def _normalize_mutation_candidate(self, candidate: Dict) -> Dict:
        # Handles mutation outputs from quant_ecosystem.operating.strategy_bank.mutation.mutation_engine.
