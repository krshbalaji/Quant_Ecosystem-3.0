...
from quant_ecosystem.research.autonomous_controller.event_bus import BusEvent
from quant_ecosystem.research.autonomous_controller.mode_manager import ControlMode
...
class AutonomousTradingLoop:
    ...
    def _run_forever(self) -> None:
        while not self._stop.is_set() and self.shutdown_handler.is_running():
            self.run_cycle()
