...
from quant_ecosystem.research.regime_transition.trend_shift_detector import TrendShiftDetector
from quant_ecosystem.research.regime_transition.volatility_shift_detector import VolatilityShiftDetector
