...
from quant_ecosystem.research.alpha_genome.alpha_gene_pool import AlphaGene, AlphaGenePool
...
class AlphaDNABuilder:
    ...
    def _fallback_gene(self, slot: str) -> AlphaGene:
        ...
        from quant_ecosystem.research.alpha_genome.alpha_gene_pool import GENE_TEMPLATES
