...
from quant_ecosystem.research.alpha_genome.genome_crossbreeder import GenomeCrossbreeder
from quant_ecosystem.research.alpha_genome.genome_mutator import GenomeMutator
...
class GenomeGenerator:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if research_memory is not None:
            try:
                from quant_ecosystem.research.alpha_genome._memory_bridge import GenomeMemoryBridge
    ...
    def generate_random(self, count: int = 10, seed: int | None = None, regime: str = "all") -> List[Dict]:
        ...
        for _ in range(max(1, int(count))):
            ...
            if self._library:
                from quant_ecosystem.research.alpha_genome.genome_library import GenomeRecord
